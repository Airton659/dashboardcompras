export function Gauge({ percentual, alturaVh = 12 }: { percentual: number; alturaVh?: number }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      <svg viewBox="0 0 100 58" style={{ height: `${alturaVh}vh`, width: 'auto', maxWidth: '100%' }}>
      ...
      <span style={{ fontSize: '1.05vh', color: 'var(--slate)', marginTop: '.25vh' }}>Concluídos no prazo · meta 80%</span>
    </div>
  );
}
